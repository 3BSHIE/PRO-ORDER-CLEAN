...
export const translations = {
  en: {
    ...
    kitchen: {
      ...
      kitchenAlertsHint: "Played on the Kitchen board. Each alert needs its own sound. Changes apply immediately.",
  ...
  ar: {
    ...
    kitchen: {
      ...
      kitchenAlertsHint: "يُشغَّل في لوحة المطبخ. لكل تنبيه صوته الخاص. تُطبَّق التغييرات فوراً.",
